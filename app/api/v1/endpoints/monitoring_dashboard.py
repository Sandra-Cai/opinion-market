...
async def get_dashboard_overview(current_user: Dict[str, Any] = Depends(get_current_user)):
...
async def get_dashboard_alerts(current_user: Dict[str, Any] = Depends(get_current_user)):
...
async def get_performance_analysis(current_user: Dict[str, Any] = Depends(get_current_user)):
...
def _get_active_alerts(self, cpu_percent: float, memory_percent: float, db_status: str) -> List[Dict[str, Any]]:
...
def _generate_performance_recommendations(self, metrics: Dict[str, Any]) -> List[Dict[str, Any]]:
