    ...
    try:
        while True:
            ...
            if message.get("type") == "ping":
                ...
                await websocket.send_text(json.dumps({"type": "subscribed", "market_id": market_id}))
        ...
        while True:
            ...
            if message.get("type") == "ping":
                ...
                portfolio_update = {
                    ...
                    "data": {
                        "message": "Portfolio update would be sent here"
                    }
                }
        ...
        while True:
            ...
            if message.get("type") == "ping":
                ...
                stats_update = {
                    "type": "market_stats",
                    "data": {
                        "message": "Global market stats would be sent here"
                    }
                }
