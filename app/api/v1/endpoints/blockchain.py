...
from app.services.blockchain_integration import (
    ...
    SmartContract, BlockchainTransaction, MarketToken, OracleData
)
from app.schemas.blockchain import (
    MarketCreationRequest, MarketCreationResponse,
    TradeRequest, TradeResponse, TokenCreationRequest, TokenResponse,
    OracleDataRequest, OracleDataResponse, TransactionStatusResponse,
    ContractInfoResponse, NetworkStatusResponse
)
...
async def create_market_on_blockchain(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Error creating market on blockchain")
...
@router.get("/transactions/{transaction_hash}", response_model=TransactionStatusResponse)
async def get_transaction_status(
    ...
    try:
        ...
        transaction_data = await blockchain_service._get_transaction_data(transaction_hash, network)
...
async def get_contract_info(
    ...
    try:
        ...
        contract_data = await blockchain_service._get_contract_data(contract_address, network)
...
async def get_recent_transactions(
    ...
    try:
        ...
        recent_transactions = await blockchain_service._get_recent_transactions(network, limit)
...
async def get_blockchain_analytics(
    ...
    try:
        ...
        analytics = await blockchain_service._get_blockchain_analytics(network, timeframe)
        ...
        raise HTTPException(status_code=500, detail="Error getting blockchain analytics")
