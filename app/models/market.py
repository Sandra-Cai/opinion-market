...
class Market(Base):
    ...
    # Relationships
    creator = relationship("User", foreign_keys=[creator_id], back_populates="markets_created")
    ...
    def calculate_trending_score(self):
        ...
        recent_trades = [t for t in self.trades if t.created_at >= datetime.utcnow() - timedelta(hours=24)]
