...
class TransactionStatusResponse(BaseModel):
    ...
    network: str = Field(..., description="Blockchain network")
    timestamp: datetime = Field(..., description="Transaction timestamp")
    contract_interaction: bool = Field(..., description="Whether it's a contract interaction")
...
class ContractDeploymentRequest(BaseModel):
    ...
    network: str = Field(..., description="Blockchain network")
    contract_data: Optional[Dict[str, Any]] = Field(None, description="Contract deployment data")
