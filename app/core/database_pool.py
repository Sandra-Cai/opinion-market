...
class QueryOptimizer:
    ...
    def optimize_query(query: str) -> str:
        ...
        if "SELECT" in optimized.upper():
            ...
            if "WHERE" in optimized.upper() and "ORDER BY" in optimized.upper():
                ...
                logger.debug("Query could benefit from composite index on WHERE and ORDER BY columns")
    ...
    def get_query_metrics(query: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "has_subqueries": "SELECT" in query.upper().split("FROM")[1:] if "FROM" in query.upper() else False,
            "has_aggregations": any(func in query.upper() for func in ["COUNT", "SUM", "AVG", "MIN", "MAX"]),
