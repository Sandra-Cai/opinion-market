...
async def redis_client():
    ...
    redis_client = redis.from_url("redis://localhost:6379/1")  # Use database 1 for testing
...
def integration_test_data():
    ...
    return {
        "user_workflow": [
            {"action": "register", "data": {"username": "testuser", "email": "test@example.com"}},
            {"action": "login", "data": {"username": "testuser", "password": "password123"}},
            {"action": "create_market", "data": {"title": "Test Market", "outcome_a": "Yes", "outcome_b": "No"}},
            {"action": "place_trade", "data": {"market_id": 1, "shares": 10.0, "outcome": "outcome_a"}},
            {"action": "create_post", "data": {"content": "Test post", "post_type": "general"}}
        ],
        "admin_workflow": [
            {"action": "login", "data": {"username": "admin", "password": "admin123"}},
            {"action": "verify_market", "data": {"market_id": 1, "status": "verified"}},
            {"action": "resolve_dispute", "data": {"dispute_id": 1, "resolution": "resolved"}},
...
class TestUtils:
    ...
    @staticmethod
    def create_test_market(client, headers: Dict[str, str], market_data: Dict[str, Any]) -> int:
    ...
    @staticmethod
    def place_test_trade(client, headers: Dict[str, str], trade_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    @staticmethod
    def create_test_post(client, headers: Dict[str, str], post_data: Dict[str, Any]) -> Dict[str, Any]:
